...
<table style="width:100%">
 ...
 <tr>
  ...
  <tr>
      <td>POST</td>
      <td>/users/{id}/avatar</td>
      <td>Upload user avatar</td>
      <td><a href="#uploadAvatar">Info</a></td>
      <td></td>
  </tr>
  <tr>
      <td>POST</td>
      <td>/users/{id}/banner</td>
      <td>Upload user banner</td>
      <td><a href="#uploadBanner">Info</a></td>
      <td></td>
  </tr>
  <tr>
      <td>GET</td>
      <td>/users/{id}/media</td>
      <td>Get user media(avatar & banner)</td>
      <td></td>
      <td></td>
  </tr>
  <tr>
      <td>POST</td>
      <td>/characters/users/{userId}</td>
      <td>Create character by userId</td>
      <td></td>
      <td></td>
  </tr>
  <tr>
